...
OUTPUT_CSV = f"plots/{FOLDER}/{PROMPT_VERSION}_{MODEL_NAME}_accuracy_vs_confidence_f1.png"
...
sns.scatterplot(data=df, x='confidence', y='f1', s=25, color='teal', alpha=0.6)
